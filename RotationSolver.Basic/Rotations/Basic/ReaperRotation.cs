...
public partial class ReaperRotation
{
	...
	{
		setting.ActionCheck = () => HasSoulReaver && Shroud <= 90;
	}
	...
	{
		setting.ActionCheck = () => HarvestMoonPvEReady && HasSoulsow && Soul <= 90;
	}
	...
	{
		setting.ActionCheck = () => ExecutionersGibbetPvEReady && HasExecutioner && Shroud <= 90;
	}

	static partial void ModifyExecutionersGallowsPvE(ref ActionSetting setting)
	{
		setting.ActionCheck = () => ExecutionersGallowsPvEReady && HasExecutioner && Shroud <= 90;
	}

	static partial void ModifyExecutionersGuillotinePvE(ref ActionSetting setting)
	{
		setting.ActionCheck = () => ExecutionersGuillotinePvEReady && HasExecutioner && Shroud <= 90;
	}
